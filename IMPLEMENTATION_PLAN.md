...
| 13B | Jev-routed AI Chat | Complete; Jev conditionally invokes SQL, repairs one schema-incompatible query automatically, and durable Supabase chat sessions support new, reopen, and archive flows | Apply migrations `011`, `013`, and `019`<br>`npm run dashboard`<br>Open **AI Space → AI Chat** |
